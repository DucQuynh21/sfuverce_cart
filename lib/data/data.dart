...
import 'package:sfuverce_app/custom_icons/custom_icons_icons.dart';
import 'package:sfuverce_app/models/cart.dart';
import 'package:sfuverce_app/models/chair.dart';
import 'package:sfuverce_app/models/user.dart';
...
final _dinningChair = Chair(
  ...
  height: 32,
  weight: 30,
  backgorundColor: Color.fromARGB(255, 171, 191, 201),
);
...
final _hvenChair = Chair(
  ...
  height: 36,
  weight: 38,
  backgorundColor: Color.fromARGB(255, 245, 208, 154),
);
...
final _loungeChair = Chair(
  ...
  height: 28,
  weight: 30,
  backgorundColor: Color.fromARGB(255, 175, 153, 218),
);
